...
export const MOCK_NAMES: string[] = [
    "Adriana Abigail Sánchez Velis",
    "Andrea Nicole Gutiérrez Galeas",
    "Andrea Saraí Zarpate Villalta",
    "Daila Jahaziel Gómez Lizama",
    "Gabriela Leonor Rivas Zelada",
    "Genesis Betsabé Cruz Lemus",
    "Karla Nikery Méndez Melgar",
    "Paola Michelle Deras Lazo",
    "Rosa Del Carmen Calderón López",
    "Rosalva Rosibel Barrera Ramirez",
    "Sherlyn Stephanie Ascencio Hernández",
    "Vanessa Iveth Rogel Rivas",
    "Yara Ledin Ramírez Turcios",
    "Alisson Berenice Guerrero Barrera",
    "Yeili Tatiana Chavez Ventura",
    "Alejandra Sofía Monroy Moza",
    "Alejandra Stephany Abrego Palacíos",
    "Ana María Pérez Carrillo",
    "Arianna Valeria García Mozo",
    "Beverly Elena Menjívar Guillén",
    "Fátima María Medina Ferrufino",
    "Geiser Michelle Sánchez Zetino",
    "Karen Abigail Funes Pasin",
    "Kenia Elizabeth Ponce Rauda",
    "Kenneth Nohemy Palacios Guevara",
    "Nathaly Nayeli Cruz Merino",
    "Olivia Raquel Rodríguez Benitez",
    "Ruth Esther Miranda López",
    "Sofia Yaneth Marquina Serrano",
    "Valerie Iveth Rodríguez Hernández",
...
export const schedule: ScheduleItem[] = [
    { date: '2025-07-21', course: '1. Fundamentos del soporte técnico', module: 'Hardware' },
